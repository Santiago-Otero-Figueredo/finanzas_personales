...
var chart = am4core.create('grafica_movimientos', am4charts.XYChart)
chart.colors.step = 2;
...
xAxis.renderer.labels.template.horizontalCenter = "center";
xAxis.renderer.labels.template.location = 0.5;

var yAxis = chart.yAxes.push(new am4charts.ValueAxis());
//yAxis.title.text = 'Cantidad ($) en miles'
yAxis.min = 0;
...
createSeries('ingresos', 'Ingresos');
createSeries('gastos', 'Gastos');
